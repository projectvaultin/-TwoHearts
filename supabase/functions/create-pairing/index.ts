// TwoHearts Edge Function: create-pairing
...
Deno.serve(async (req) => {
  ...
  return new Response(JSON.stringify({ok:false,function:'create-pairing',configured:false}),{status:501,headers:{'content-type':'application/json'}});
});
