// TwoHearts Edge Function: reveal-surprise
...
Deno.serve(async (req) => {
  ...
  return new Response(JSON.stringify({ok:false,function:'reveal-surprise',configured:false}),{status:501,headers:{'content-type':'application/json'}});
});
