// TwoHearts Edge Function: delete-account
...
Deno.serve(async (req) => {
  ...
  return new Response(JSON.stringify({ok:false,function:'delete-account',configured:false}),{status:501,headers:{'content-type':'application/json'}});
});
