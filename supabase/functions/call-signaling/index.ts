// TwoHearts Edge Function: call-signaling
...
Deno.serve(async (req) => {
  ...
  return new Response(JSON.stringify({ok:false,function:'call-signaling',configured:false}),{status:501,headers:{'content-type':'application/json'}});
});
