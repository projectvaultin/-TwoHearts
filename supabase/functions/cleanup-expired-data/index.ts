// TwoHearts Edge Function: cleanup-expired-data
...
Deno.serve(async (req) => {
  ...
  return new Response(JSON.stringify({ok:false,function:'cleanup-expired-data',configured:false}),{status:501,headers:{'content-type':'application/json'}});
});
