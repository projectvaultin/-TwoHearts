// TwoHearts Edge Function: complete-pairing
...
Deno.serve(async (req) => {
  ...
  return new Response(JSON.stringify({ok:false,function:'complete-pairing',configured:false}),{status:501,headers:{'content-type':'application/json'}});
});
